                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="horz-layout-card-center">Kategori Berita</h4>
                                        ...
                                        <div class="card-body card-dashboard">
                                            <div
                                                ...
                                                <a href="{{ route('kategori_berita.create') }}"
                                                    ...
                                                    <i data-feather="plus"></i> Tambah Kategori Berita
                                                </a>
                                            </div>
                                                ...
                                                <table class="table table-striped table-bordered" id="@yield('table')">
                                                    ...
                                                    <tbody id="tableBody">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    @include('components.action.action', [
                                                                        'item' => $item,
                                                                        'editRoute' => 'kategori_berita.edit',
                                                                        'destroyRoute' =>
                                                                            'kategori_berita.destroy',
                                                                    ])
                                                                </td>
                                                            </tr>
                                                        @endforeach
                                                        ...
                                                        <tr id="noDataRow" style="display: none;">
                                                            <td colspan="3" class="text-center text-muted">🔍 Data tidak
                                                                ditemukan</td>
                                                        </tr>
                                                    </tbody>
                                                    <tfoot>
