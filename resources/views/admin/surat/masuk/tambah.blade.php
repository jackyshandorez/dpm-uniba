                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title" id="horz-layout-card-center">Isi Data Surat Masuk</h4>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" name="nomor_surat"
                                                            ...
                                                            value="{{ old('nomor_surat') }}" placeholder="Nomor Surat">
                                                        @error('nomor_surat')
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" name="pengirim"
                                                            ...
                                                            value="{{ old('pengirim') }}" placeholder="Pengirim Surat">
                                                        @error('pengirim')
                                                            <div class="invalid-feedback">{{ $message }}</div>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" name="perihal"
                                                            ...
                                                            value="{{ old('perihal') }}" placeholder="Perihal Surat">
                                                        @error('perihal')
                                                            <div class="invalid-feedback">{{ $message }}</div>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="file" name="file_lampiran"
                                                            ...
                                                            <small class="text-muted">Format: PDF, DOC, DOCX, JPG, PNG. Ukuran maksimal 5 MB.</small>
                                                        @error('file_lampiran')
