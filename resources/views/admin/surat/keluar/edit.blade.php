                    ...
                    <div class="breadcrumbs-top float-md-right">
                        <div class="breadcrumb-wrapper mr-1">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a
                                        href="{{ route('surat.keluar.index') }}">@yield('breadcrumb2')</a></li>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Ubah Data Surat Keluar</h4>
                        </div>
                            ...
                            <div class="card-body">
                                <form action="{{ route('surat.keluar.update', $suratKeluar->id) }}" method="POST"
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        @if ($suratKeluar->file_lampiran)
                                                            <a href="{{ asset('storage/' . $suratKeluar->file_lampiran) }}"
                                                            ...
                                                            @php
                                                                $ext = pathinfo(
                                                                    $suratKeluar->file_lampiran,
                                                                    PATHINFO_EXTENSION,
                                                                );
                                                            @endphp

                                                            @if (in_array(strtolower($ext), ['jpg', 'jpeg', 'png']))
                                                                <img src="{{ asset('storage/' . $suratKeluar->file_lampiran) }}"
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <select name="status"
                                                            ...
                                                            <option value="baru"
                                                                {{ old('status', $suratKeluar->status) == 'baru' ? 'selected' : '' }}>
                                                                Baru</option>
                                                            <option value="diproses"
                                                                {{ old('status', $suratKeluar->status) == 'diproses' ? 'selected' : '' }}>
                                                                Diproses</option>
                                                            <option value="selesai"
                                                                {{ old('status', $suratKeluar->status) == 'selesai' ? 'selected' : '' }}>
                                                                Selesai</option>
                                                        </select>
                                                        @error('status')
                                                            <div class="invalid-feedback d-block">{{ $message }}</div>
                                    ...
                                    <div class="form-actions center">
                                        <a href="{{ route('surat.keluar.index') }}" class="btn btn-danger mr-1">
