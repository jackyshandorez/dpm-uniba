                ...
                <div class=" col-xl-6 col-lg-8 col-md-10">
                    <div class="card">
                        ...
                        <div class="card-content collapse show">
                            <div class="card-body">
                                <form class="form form-horizontal" action="{{ route('fakultas.update', $fakultas->id) }}"
                                    method="POST">
                                    @csrf
                                    ...
                                    <div class="form-body">
                                        <div class="form-group row">
                                            <label class="col-md-3 label-control" for="nama">Nama Fakultas<span
                                                    class="text-danger">*</span></label>
                                            <div class="col-md-9">
                                                <input type="text" id="nama" class="form-control" name="nama"
                                                    value="{{ $fakultas->nama }}" required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-actions center">
                                        <button type="button" class="btn btn-danger mr-1" onclick="window.history.back()">
                                            ...
                                            <x-action.button>Batal</x-action>
                                        </button>
