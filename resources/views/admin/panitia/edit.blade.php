                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" name="nomor_surat"
                                                            ...
                                                            value="{{ old('nomor_surat', $suratKeluar->nomor_surat) }}" placeholder="Nomor Surat" required>
                                                        @error('nomor_surat')
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" name="penerima"
                                                            ...
                                                            value="{{ old('penerima', $suratKeluar->penerima) }}" placeholder="Penerima Surat" required>
                                                        @error('penerima')
                                                            <div class="invalid-feedback">{{ $message }}</div>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" name="perihal"
                                                            ...
                                                            value="{{ old('perihal', $suratKeluar->perihal) }}" placeholder="Perihal Surat" required>
                                                        @error('perihal')
                                                            <div class="invalid-feedback">{{ $message }}</div>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <select name="status"
                                                            ...
                                                            <option value="baru" {{ old('status', $suratKeluar->status) == 'baru' ? 'selected' : '' }}>Baru</option>
