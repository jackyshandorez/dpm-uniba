                ...
                <div class=" col-xl-6 col-lg-8 col-md-10">
                    <div class="card">
                        ...
                        <div class="card-content collapse show">
                            <div class="card-body">
                                <form class="form form-horizontal" action="tambah_jabatan" method="POST">
                                    @csrf
                                    <div class="form-body">
                                        <!-- Nama Jabatan -->
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" id="nama_jabatan"
                                                    ...
                                                    placeholder="Contoh: Ketua" name="nama_jabatan"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <textarea id="tanggung_jawab" class="form-control @error('tanggung_jawab') is-invalid @enderror"
                                                    placeholder="Tanggung jawab jabatan" name="tanggung_jawab" rows="4">{{ old('tanggung_jawab') }}</textarea>
